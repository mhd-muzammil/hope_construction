    ...
    return (
        <section className="relative w-full py-24 sm:py-32 md:py-40 lg:py-48 flex items-center justify-center overflow-hidden group">
            ...
            <div className="relative z-10 w-full max-w-[1440px] px-6 sm:px-10 md:px-16 lg:px-20 xl:px-28 mx-auto">
                <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-10 lg:gap-16 xl:gap-24">

                    {/* Left: Headline */}
                    <div className="w-full lg:w-[55%] xl:w-3/5">
                        <h2 className="text-[2rem] sm:text-[2.8rem] md:text-[3.5rem] lg:text-[3.8rem] xl:text-[4.5rem] font-extrabold text-white leading-[1.05] tracking-tight uppercase font-heading drop-shadow-md">
                    ...
                    <div className="w-full lg:w-[45%] xl:w-2/5 flex flex-col items-start">
                        <p className="text-white/95 text-[15px] sm:text-[17px] md:text-[19px] font-medium leading-relaxed mb-8 md:mb-10 drop-shadow">
                        ...
                        <button className="flex items-stretch group/btn cursor-pointer mt-2 overflow-hidden shadow-lg">
